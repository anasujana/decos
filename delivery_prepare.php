...
<body>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <form action="" method="" id="formScanCst">
                                                                        <input type="hidden" name="no_deliv1" id="no_deliv1" class="form-control form-control-round" value="<?php if (isset($_GET["no_filter"])) {
                                                                                                                                                                                echo $_GET["no_filter"];
                                                                                                                                                                            };
                                                                                                                                                                            ?>">

                                                                        <input type="hidden" name="part_fln_scan1" id="part_fln_scan1" class="form-control form-control-round" placeholder="Scan QR Label FLN">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="date" name="tgl_kirim" value="" id="tgl_kirim" class="form-control form-control-round" required>
                            </div>
                            <div class="form-group col-md-12">
    ...
    <!-- insert sj -->
    <?php
    if (isset($_POST['no_deliv']) and isset($_POST['no_sj']) and isset($_POST['tgl_kirim'])) {
        // terima data                                 
        ...
        // update tgl kirim
        $update_tgl_kirim = mysqli_query($conn, "UPDATE plan SET tgl_kirim='$tgl_kirim' WHERE no_delivery='$rec_no_deliv'");
        ...
        $del_rec_last = substr($del_rec, -1);
        // pecah no_delivery                                 
        $rec_part_no = explode("-", $del_rec);
        // Mengambil data kecuali elemen terakhir
        $jumlahData = count($rec_part_no);
        $no_deliv_rec = array_slice($rec_part_no, 0, $jumlahData - 1);
        $no_deliv_rec = implode("-", $no_deliv_rec);
        ...
        foreach ($compare as $data) {
            ...
            $no_deliv = "$no_deliv_rec" . "-" . "REC$rec";

            if ($compare_plan != $compare_actual) {
                $minus = $compare_plan - $compare_actual;
                // 2.1 insert plan
                $add_plan = mysqli_query($conn, "INSERT INTO plan VALUES (null,'$compare_part_no','$compare_tgl','$id_customer','$id_cycle','$minus','$no_deliv',null)");
                //2.2 update plan
