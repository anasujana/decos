...
<div id="pcoded" class="pcoded">
                                                ...
                                                <div class="card-body">                                                   
                                                    <form target="_blank" action="label_print.php" method='POST'>   
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select name="content" id="content" class="form-control form-control-round" onchange="autofill()">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input type="number" name="qty_qr" class="form-control form-control-round" placeholder="Input Qty Packaging" required>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
    ...
    <script type="text/javascript">
        function myFunction(){
            ...
            $("#content").load("qr_code/no_part_reprint.php?line="+id_line+"")
        };
    </script>
    <!-- isi snp -->
