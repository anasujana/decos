    ...
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="daily_delivery.php" class="waves-effect waves-dark">
                    ...
                    <span class="pcoded-mtext" data-i18n="nav.dash.main">Delivery Perfomance</span>
            ...
            <li class="">
                <a href="monthly_delivery.php" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-dashboard"></i><b>D</b></span>
                    <span class="pcoded-mtext" data-i18n="nav.dash.main">Monthly Achievement</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li>
        </ul>
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="">
                <a href="andon_wh.php" class="waves-effect waves-dark">
                    <span class="pcoded-micon"><i class="ti-dashboard"></i><b>D</b></span>
                    <span class="pcoded-mtext" data-i18n="nav.dash.main">Andon Monitoring</span>
                    <span class="pcoded-mcaret"></span>
                </a>
            </li>
        </ul>
        ...
        if ($_SESSION["id_dept"] != 2) {
            ...
            <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Preparation Delivery</div>
                ...
                <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Stok Data</div>
                <ul class="pcoded-item pcoded-left-item">
                    <li class="">
                        <a href="all_stock.php" class="waves-effect waves-dark">
                            <span class="pcoded-micon"><i class="ti-package"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Stock all</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class="pcoded-hasmenu">
                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                            ...
                            <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Output Jurnal</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                        <ul class="pcoded-submenu">
                            <li>
                                <a href="oj.php?kategori=1" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Produksi</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                            <li class=" ">
                                <a href="oj.php?kategori=2" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">WIP Produksi</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li> 
                            <li class=" ">
                            <a href="oj.php?kategori=3" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">WIP RM</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li> 
                        </ul>
                    ...
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">WIP</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li>
                            <a href="wip.php?kategori=2" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                <span class="pcoded-mtext" data-i18n="nav.form-components.main">Produksi</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        ...
                        <li class=" ">
                            <a href="wip.php?kategori=3" class="waves-effect waves-dark">
                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">RM</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li> 
                    </ul>
