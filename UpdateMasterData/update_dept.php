                                            ...
                                            <div class="col-md-12 d-print-none">
                                                <div class="card shadow mb-12">
                                                    ...
                                                    <?php
                                                        ...
                                                        $dept = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM departemen WHERE id_dept='$id_dept'"));
                                                        $id = $dept['id_dept'];
                                                    ...
                                                    ?>                                                   
                                                        <form method='POST'>   
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" value="<?php echo $nama_dept;?>" name="dept_edit"
                                                                    class="form-control form-control-round">
                                                                </div>
                                                            </div>  
                                                            <div class="float-left">
                                                                <a href="../master_data/departemen.php"><button type="button" class="btn btn-secondary btn-round">Close</button></a>
                                                        ...
                                                        <?php
                                                            if(isset($_POST['submit'])){
                                                                ...
                                                                $update_dept = mysqli_query($conn, "UPDATE departemen SET nama_dept='$dept_edit' where id_dept='$id_edit'");
                                                                echo '<script languange="javascript">
                                                                            swal.fire({
                                                                                title: "Success",
                                                                                text: "Departemen Updated",
                                                                                icon:"success",
                                                                                timer: 1500
                                                                            }).then(function(){
                                                                                window.location.href="../master_data/departemen.php";
                                                                                });
                                                                        </script>';    
                                                            };
