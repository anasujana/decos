...
<body>
                                                                    ...
                                                                    <table class="table table-bordered text-center" id="stok_data">
                                                                        <thead>
                                                                            <tr style="text-align: center;">
                                                                                ...
                                                                                <th style="width: 28px;" colspan="3" class="text-center" style="vertical-align: middle;">&nbsp;PLAN DELIVERY</th>
    ...
    <script>
        const dataSource = {
            chart: {
                caption: "Delivery Status On This Day",
                subcaption: "",
                lowerlimit: "0",
                upperlimit: "100",
                showvalue: "1",
        ...
        var options = {
            ...
            dataLabels: {
                ...
                formatter: function(val, opts) {
                    if (opts.seriesIndex === 2) { // Format labels for series "ach" (index 2)
                        // Format the label for series "ach"
                        var planingValue = <?php echo json_encode($planing_data); ?>[opts.dataPointIndex];
                        // Check if 'planing' value is null or 0, and hide the data label
                        if (planingValue == 0) {
                            return " ";
                        } else if (val % 1 === 0) {
                            return val.toString() + "%";
                    ...
                    } else if (opts.seriesIndex === 0 || opts.seriesIndex === 1 || opts.seriesIndex === 2) { // Return " " for series "target (100%)"
                        // Get the corresponding 'planing' value for the current data point
                        var planingValue = <?php echo json_encode($planing_data); ?>[opts.dataPointIndex];
                    ...
                    return val; // Default case for other series
                },
