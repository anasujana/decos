            ...
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                            <div class="page-header-title">
                                                <h5 class="m-b-10">List User Role</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="">
                                                <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#role">Add User Role <i class="ti-plus"></i></button>                             
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row"> 
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="user_id" class="form-control form-control-round">
                                            ...
                                            <div class="form-group col-md-12">
                                                <label class="col-sm-12 col-form-label">Pilih Role User</label>
                                                <select name="role" class="form-control form-control-round" required>
                        ...
                        if(isset($_POST['save'])){
                            $user = $_POST['user_id'];
                            $role = $_POST['role'];
                            $add_role = mysqli_query($conn,"INSERT INTO role_user VALUES ('$user','$role')"); 
                            echo '<script languange="javascript">
                                        swal.fire({
                                            title: "Success",
                                            text: "Role Ditambahkan",
                                            icon:"success",
                                        }).then(function(){
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped plan_deliv datas">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $role = mysqli_query ($conn,"SELECT id,
                                                                                                        user_role 
                                                                                                    FROM role_user");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $role; ?></td>
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_user_role.php?id_user=<?php echo $nama;?>" class="alert_notif"> 
                                                                                <button type='button' class='btn btn-danger btn-round text-dark'>Hapus &nbsp;&nbsp;<i class="ti-trash"></i></button>
                                                                            </a>
                                                                            <a href="../UpdateMasterData/update_user_role.php?id_user=<?php echo $nama;?>"> 
