        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="">
                                                <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#add_line">Add Line <i class="ti-plus"></i></button>                             
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <!-- Modal add line-->
                        <div class="modal fade" id="add_line" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-row">            
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="line_add" class="form-control form-control-round" placeholder="Input Line Name" autofocus>
                                            </div>                                
                                        </div>
                        ...
                        if(isset($_POST['line_add'])){
                            $line_add = $_POST['line_add'];
                            $add_line = mysqli_query($conn,"INSERT INTO line (id_line,name_line) VALUES (NULL,'$line_add')"); 
                            echo '<script languange="javascript">
                                        swal.fire({
                                            title: "Success",
                                            text: "Line Ditambahkan",
                                            icon:"success",
                                        }).then(function(){
                                            window.location.href="line_prod.php";
                                            });
                                    </script>'; 
                        };
                        ?> 
                                                ...
                                                <div class="card"> 
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped line datas">
                                                                <thead>
                                                                <th>ID</th> 
                                                                <th>LINE</th>
                                                                <th>ACTION</th>
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $list_customer = mysqli_query ($conn,"SELECT * FROM line");
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo $id; ?></td>
                                                                        <td><?php echo $name_line; ?></td>
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_line.php?id_line=<?php echo $id;?>" class="alert_notif"> 
                                                                                <button type='button' class='btn btn-danger btn-round text-dark'>Hapus &nbsp;&nbsp;<i class="ti-trash"></i></button>
                                                                            </a>
                                                                            <a href="../UpdateMasterData/update_line.php?id_line=<?php echo $id;?>"> 
