        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">List Customer (Produksi)</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="">
                                                <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#add_cs_prod">Add Customer <i class="ti-plus"></i></button>                             
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <!-- Modal add Customer-->
                        <div class="modal fade" id="add_cs_prod" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add Customer (Produksi)</h5>
                                    ...
                                    <form action="" method="POST">
                                        <div class="form-row">            
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="cs_prod_add" class="form-control form-control-round" placeholder="Input Customer Name" autofocus>
                                            </div>                                
                                        </div>
                        ...
                        <?php
                        if(isset($_POST['cs_prod_add'])){
                            $cs_prod_add = $_POST['cs_prod_add'];
                            $add_cs = mysqli_query($conn,"INSERT INTO customer_prod (id,customer) VALUES (NULL,'$cs_prod_add')"); 
                            echo '<script languange="javascript">
                                        swal.fire({
                                            ...
                                            window.location.href="customer_prod.php";
                                            });
                                    </script>';   
                        };
                        ?> 
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped plan_deliv datas">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $list_customer = mysqli_query ($conn,"SELECT * FROM customer_prod");
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_cst_prod.php?id_cs=<?php echo $id;?>" class="alert_notif"> 
                                                                                <button type='button' class='btn btn-danger btn-round text-dark'>Hapus &nbsp;&nbsp;<i class="ti-trash"></i></button>
                                                                            </a>
                                                                            <a href="../UpdateMasterData/update_cst_prod.php?id_cs_prod=<?php echo $id;?>"> 
