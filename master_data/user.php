                ...
                <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="">
                                                <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#add_user">Add User <i class="ti-plus"></i></button>                             
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row"> 
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="nik" class="form-control form-control-round" placeholder="Input User ID" autofocus>
                                            </div>  
                                            <div class="form-group col-md-12">
                                                <label for="Nama">PASSWORD</label>
                                                <input type="password" name="password" class="form-control form-control-round" placeholder="Input Password">
                                            </div>                                
                                        </div>
                        ...
                        <?php
                            if(isset($_POST['save'])){
                                ...
                                $hash_password = password_hash("$rec_password", PASSWORD_DEFAULT);

                                // tambahkan ke database    
                                $add = mysqli_query($conn,"INSERT INTO user VALUES ('$rec_nik','$hash_password')"); 
                                                        ...
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped plan_deliv datas">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                    <tr>
                                                                        <td><?php echo $id_employe; ?></td>
                                                                        <td><?php echo $pass; ?></td>
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_user.php?id_user=<?php echo $id_employe;?>" class="alert_notif"> 
