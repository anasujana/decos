        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                            ...
                            <div class="page-block">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                            ...
                                            <h5 class="m-b-10">List User Area</h5>
                                    ...
                                    <div class="col-md-4">
                                            <ul class="breadcrumb-title">
                                                <li class="">
                                                    <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#user_area">Add User Area <i class="ti-plus"></i></button>                             
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade" id="user_area" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Add User Area</h5>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row"> 
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="user_area" class="form-control form-control-round">
                                                    <option value="">-- Pilih User--</option>
                                                    <?php
                                                    $cust = mysqli_query($conn,"SELECT id FROM user order by id asc");
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <select name="area_id" id="" class="form-control form-control-round">
                        ...
                        <?php
                        if(isset($_POST['save'])){
                            $user = $_POST['user_area'];
                            $area = $_POST['area_id'];
                            
                            $add_user_area = mysqli_query($conn,"INSERT INTO user_area VALUES ('$user','$area')"); 
                            echo '<script languange="javascript">
                                        swal.fire({
                                            title: "Success",
                                            text: "User Area Ditambahkan",
                                            icon:"success",
                                        }).then(function(){
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped plan_deliv datas">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $user_area = mysqli_query ($conn,"SELECT ua.id_user,
                                                                                                             ar.nama_area ,
                                                                                                             dept.nama_dept
                                                                                                    FROM user_area ua
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_user_area.php?id_user=<?php echo $nama;?>" class="alert_notif"> 
                                                                                <button type='button' class='btn btn-danger btn-round text-dark'>Hapus &nbsp;&nbsp;<i class="ti-trash"></i></button>
                                                                            </a>
                                                                            <a href="../UpdateMasterData/update_user_area.php?id_user=<?php echo $nama;?>"> 
