        ...
        <div class="pcoded-main-container">
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            <li class="">
                                                <button type="button" class="btn btn-white btn-round text-dark" data-toggle="modal" data-target="#add_cs_deliv">Add Cycle <i class="ti-plus"></i></button>                             
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <!-- Modal add cycle deliv-->
                        <div class="modal fade" id="add_cs_deliv" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Add Cycle Delivery</h5>
                                        ...
                                        <form action="" method="POST">
                                            <div class="form-row">            
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select name="customer" class="form-control form-control-round">
                                                        <option value="">-- Pilih Customer--</option>
                                                        <?php
                                                        $cust = mysqli_query($conn,"SELECT id, customer FROM customer_deliv where id_area='$_SESSION[id_area]' order by customer asc");
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label for="Nama">Cycle</label>
                                                    <input type="number" name="cycle" class="form-control form-control-round" placeholder="1,2,3,..">
                                                </div> 
                                                <div class="form-group col-md-12">
                                                    <label for="Nama">Jam</label>
                                                    <input type="time" name="jam" class="form-control form-control-round">
                                                </div>  
                                                <div class="form-group col-md-12">
                                                    <label for="Nama">Status</label>
                                                    <select name="status" class="form-control form-control-round" required>
                        ...
                        <?php
                            if(isset($_POST['save'])){
                                ...
                                $jam = $_POST['jam'];
                                $status = $_POST['status'];
                                $add_cs_deliv = mysqli_query($conn,"INSERT INTO cycle_deliv VALUES (NULL,'$cycle','$jam','$cust','$status')"); 
                                echo '<script languange="javascript">
                                            swal.fire({
                                                title: "Success",
                                                text: "Cycle Ditambahkan",
                                                icon:"success",
                                            }).then(function(){
                                                window.location.href="deliv_cycle.php";
                                                });
                                        </script>';   
                            };
                        ?> 
                                                    ...
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">                                                 
                                                            <table class="table table-striped plan_deliv datas">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $cycle_deliv = mysqli_query ($conn,"SELECT cd.id, cd.no_ct, cd.waktu ,cs.customer ,cd.status FROM cycle_deliv cd 
                                                                                                                                                                    left join customer_deliv cs on cs.id=cd.customer_id");
                                                                        foreach($cycle_deliv AS $data){
                                                                        $id_cycle = $data['id'];
                                                                        $cycle = $data['no_ct'];  
                                                                        $waktu = $data['waktu']; 
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="../deleteMasterData/delete_cycle_deliv.php?id_cycle=<?php echo $id_cycle;?>" class="alert_notif"> 
                                                                                <button type='button' class='btn btn-danger btn-round text-dark'>Hapus &nbsp;&nbsp;<i class="ti-trash"></i></button>
                                                                            </a>
                                                                            <a href="../UpdateMasterData/update_cycle_deliv.php?id=<?php echo $id_cycle;?>"> 
